...
String jsmConfiguration = GetterUtil.getString(preferences.getValue("JMS_CONFIGURATION", StringPool.BLANK));
%>
...
<aui:fieldset>
	...
	<aui:row>
		<aui:col>
			<aui:input helpMessage="jms-lookup-help" label="jsm.configuration" name='<%= "settings--" + "JMS_CONFIGURATION" + "--" %>' type="textarea" value="<%=jsmConfiguration %>" />
		</aui:col>
	</aui:row>
</aui:fieldset>