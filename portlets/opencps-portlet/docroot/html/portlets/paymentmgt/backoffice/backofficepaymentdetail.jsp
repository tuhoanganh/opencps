...
<div class="content overfolow">
                ...
                <div class="box50">
                    ...
                    <div>
                        <p><span><liferay-ui:message key="ngay-xac-nhan-thu-phi"/>:</span> </p><%=Validator.isNotNull(paymentFile)?HtmlUtil.escape(dateFormatDate.format(paymentFile.getApproveDatetime())): LanguageUtil.get(pageContext, "monitoring-chua-co") %>
                    </div>
                    <div>
