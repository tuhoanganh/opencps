...
public class CitizenDisplayTerms extends DisplayTerms{
	...
	public static final String CITIZEN_FULLNAME = "fullName"; 
	public static final String CITIZEN_PERSONALID = "personalId";
	public static final String CITIZEN_ADDRESS = "address";
	public static final String CITIZEN_CITYCODE = "cityCode";
	public static final String CITIZEN_DISTRICTCODE = "districtCode";
	public static final String CITIZEN_WARDCODE = "wardCode";
	public static final String CITIZEN_TELNO = "telNo";
	public static final String CITIZEN_EMAIL = "email";
	public static final String CITIZEN_CREATEDDATE = "createdDate";
	public static final String CITIZEN_MODIFIEDDATE = "modifiedDate";
	public static final String CITIZEN_BIRTHDATE = "birthDate";
	public static final String CITIZEN_UUID = "uuid";
	public static final String CITIZEN_ATTACHFILE = "attachFile";
	public static final String CITIZEN_MAPPINGUSERID = "mappingUserId";
	public static final String CITIZEN_USERID = "userId";
	public static final String CITIZEN_GROUPID = "groupId";
	public static final String CITIZEN_ACCOUNTSTATUS = "accountStatus";
	public static final String CITIZEN_GENDER = "gender";

	public CitizenDisplayTerms(PortletRequest request) {
