...
public class ResourceActionDisplayTerms extends DisplayTerms {

	public static final String RESOURCE_ACTION_RESOURCEACTIONID =
		"resourceActionId";
	public static final String RESOURCE_ACTION_NAME = "name";
	public static final String RESOURCE_ACTION_ACTIONID = "actionId";
	public static final String RESOURCE_ACTION_BITWISEVALUE = "bitwiseValue";

	public ResourceActionDisplayTerms(PortletRequest request) {
