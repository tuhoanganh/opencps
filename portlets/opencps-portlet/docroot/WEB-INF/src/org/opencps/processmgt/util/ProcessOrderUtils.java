	...
	public static Date getRecevieDate(long dossierId, long processWorkflowId,
		...
		try {
			...
			if (Validator.isNotNull(dossier.getReceiveDatetime())) {
				...
				ProcessStep currStep = ProcessStepLocalServiceUtil
						.fetchProcessStep(processWorkflow.getPreProcessStepId());

				ProcessStep nextStep = ProcessStepLocalServiceUtil
						.fetchProcessStep(processWorkflow
