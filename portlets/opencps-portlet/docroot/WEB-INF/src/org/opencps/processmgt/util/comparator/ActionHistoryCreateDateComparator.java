 ...
 * @author trungnt
 */
public class ActionHistoryCreateDateComparator extends OrderByComparator {
	...
	public ActionHistoryCreateDateComparator() {
		this(
			false);
	}

	public ActionHistoryCreateDateComparator(boolean ascending) {
