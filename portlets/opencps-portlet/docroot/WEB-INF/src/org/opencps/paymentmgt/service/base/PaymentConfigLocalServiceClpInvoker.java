...
public class PaymentConfigLocalServiceClpInvoker {
	public PaymentConfigLocalServiceClpInvoker() {
		...
		_methodName48 = "addPaymentConfig";
		...
		_methodName49 = "updatePaymentConfig";
		...
		_methodName50 = "getPaymentConfigByGovAgency";
	...
	public Object invokeMethod(String name, String[] parameterTypes,
		...
		if (_methodName0.equals(name) &&
			...
			return PaymentConfigLocalServiceUtil.addPaymentConfig((org.opencps.paymentmgt.model.PaymentConfig)arguments[0]);
		}
		...
		if (_methodName3.equals(name) &&
			...
			return PaymentConfigLocalServiceUtil.deletePaymentConfig((org.opencps.paymentmgt.model.PaymentConfig)arguments[0]);
		}
		...
		if (_methodName15.equals(name) &&
			...
			return PaymentConfigLocalServiceUtil.updatePaymentConfig((org.opencps.paymentmgt.model.PaymentConfig)arguments[0]);
		}
		...
		if (_methodName48.equals(name) &&
			...
			return PaymentConfigLocalServiceUtil.addPaymentConfig(((Long)arguments[0]).longValue(),
		...
		if (_methodName50.equals(name) &&
			...
			return PaymentConfigLocalServiceUtil.getPaymentConfigByGovAgency(((Long)arguments[0]).longValue(),
				((Long)arguments[1]).longValue());
		}
