...
public class DossierBackOfficeSearch extends SearchContainer<Dossier> {
	...
	public DossierBackOfficeSearch(
		...
		iteratorURL
	    	.setParameter(DossierDisplayTerms.DOSSIER_STATUS, String
	    		.valueOf(displayTerms
	    			.getDossierStatus()));
		iteratorURL
    		.setParameter(DossierDisplayTerms.SERVICE_DOMAIN_CODE, String
    			.valueOf(displayTerms
    				.getServiceDomainCode()));
	...
	private static Log _log = LogFactoryUtil
	    .getLog(DossierBackOfficeSearch.class);
}
