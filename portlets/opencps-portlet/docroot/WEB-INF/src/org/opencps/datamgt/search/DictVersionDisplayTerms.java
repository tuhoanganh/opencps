...
public class DictVersionDisplayTerms extends DisplayTerms{
	...
	public static final String VALIDATED_FROM = "validatedFrom";
	
	public static final String VALIDATED_TO = "validatedTo";

	public DictVersionDisplayTerms(PortletRequest portletRequest) {
		...
		version = ParamUtil.getString(portletRequest, VERSION);
		validatedFrom = ParamUtil.getDate(portletRequest, VALIDATED_FROM,
				DateTimeUtil.getDateTimeFormat(DateTimeUtil._VN_DATE_TIME_FORMAT));
		validatedTo = ParamUtil.getDate(portletRequest, VALIDATED_TO,
				DateTimeUtil.getDateTimeFormat(DateTimeUtil._VN_DATE_TIME_FORMAT));
		dictVersionId = ParamUtil.getLong(portletRequest, DICTVERSION_ID);
		issueStatus = ParamUtil.getInteger(portletRequest, ISSUE_STATUS);
