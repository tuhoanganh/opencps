...
public class DictCollectionSearch extends SearchContainer<DictCollection> {
	...
	public DictCollectionSearch(PortletRequest portletRequest, int cur, int delta, PortletURL iteratorURL) {

		super(portletRequest, new DictCollectionDisplayTerms(portletRequest),
				new DictCollectionSearchTerms(portletRequest), DEFAULT_CUR_PARAM, cur, delta, iteratorURL, headerNames,
				null);
		...
		DictCollectionSearchTerms searchTerms = (DictCollectionSearchTerms) getSearchTerms();
